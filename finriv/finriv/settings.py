"""
Django settings for finriv project.
...
Q_CLUSTER = {
    ...
    'ack_failures': True,
    'retry': 120,
    'orm': 'default',  # Use Django's ORM for broker
    'compress': True,  # Compress the task payloads
    'save_limit': 250,  # Number of successful tasks to save
    'queue_limit': 50,  # Limit the number of tasks in the queue
    'cpu_affinity': 1,  # Number of CPUs to use
    'max_attempts': 1,  # Max attempts before task failure
    'retry': 3600,  # Retry time in seconds
    'django_redis': 'default',  # If using Redis as a broker
}
LOGGING = {
    'version': 1,
